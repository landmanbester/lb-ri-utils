...
def main():
    """Generate cabs for all CLI functions in src/lb_ri_utils/cli."""
    ...
    cli_dir = Path("src/lb_ri_utils/cli")
    ...
    cabs_dir = Path("src/lb_ri_utils/cabs")
    ...
    image_name = f"ghcr.io/landmanbester/lb-ri-utils:{image_tag}"
