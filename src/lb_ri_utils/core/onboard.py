def onboard():
    ...
    print(
        """
================================================================================
  lb-ri-utils — Setup Instructions
================================================================================
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Push your project to GitHub:
    ...
    gh repo create landmanbester/lb-ri-utils --public --source=. --push

  Or create the repo manually at https://github.com/new and push:

    git remote add origin git@github.com:landmanbester/lb-ri-utils.git
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Click "Add a new pending publisher" and fill in:
    PyPI project name: lb-ri-utils
    Owner:             landmanbester
    Repository:        lb-ri-utils
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/lb-ri-utils/settings/environments
...
────────────────────────────────────────────────────────────────────────────────
  ...
  a) Create the app:
     ...
     Settings:
       Name:        lb-ri-utils-bot (or any name you like)
       Homepage:    https://github.com/landmanbester/lb-ri-utils
  ...
  d) Add secrets to your repository:
     ...
     Go to: https://github.com/landmanbester/lb-ri-utils/settings/secrets/actions
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/lb-ri-utils/settings/rules
